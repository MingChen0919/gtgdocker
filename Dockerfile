...
##==================================================
RUN cd /var/www/html/sites/all/modules/GTG_modules/galaxy_tool_generator && git pull && \
    cd /var/www/html/sites/all/modules/GTG_modules/galaxy_tool_generator_ui && git pull
